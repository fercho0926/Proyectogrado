...
<button title="Agregar un usuario"  class="btn btn-primary mb-2" type="button" onclick="frmUsuario();"><i class="fa fa-user-plus" aria-hidden="true"> </i>Agregar un usuario</button>
<div class="row">
    <div class="col-lg-12">
        <div class="tile">
            <div class="tile-body">
                            ...
                            <div class="modal-body">
                                <form method="post" id="frmUsuario">
                                    <div class="form-group">
                                        ...
                                        <input id="usuario" class="form-control" type="text" name="usuario" placeholder="Usuario @medellin">
                                    </div>
                                    <div class="form-group">

...
<button title="Cambiar contraseña de usuario"  class="btn btn-primary mb-2" type="button" onclick="frmCambioPass();"><i class="fa fa-user-plus" aria-hidden="true"> </i>Agregar un usuario dos</button>
<div class="row">
    <div class="col-lg-12">
        <div class="tile">
            <div class="tile-body">
